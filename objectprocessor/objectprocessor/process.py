...
def extract_person_data(datablob: str) -> List[person.Person]:
    ...
    # TODO: create an data list variable that is an empty list
...
def find_matching_people(
    ...
    # TODO: create an empty matching list to which Persons who have an attribute matching the search term in match will be added
    # TODO: iterate through all of the people in the person_data list
        # TODO: the current person has an attribute that contains the search term in match
            # TODO: add the current person to the matching list list
